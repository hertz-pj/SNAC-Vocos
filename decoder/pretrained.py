...
from decoder.feature_extractors import FeatureExtractor, MultiScaleFeatures
...
class SnacVocos(nn.Module):
    """
    The SnacVocos class represents a Fourier-based neural vocoder for audio synthesis.
    ...
    def codes_to_features(self, codes: torch.Tensor) -> torch.Tensor:
        ...
        """
        assert isinstance(
            self.feature_extractor, MultiScaleFeatures
